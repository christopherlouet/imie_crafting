...
class Perso
{
     ...
     * @var string
     *
     * @ORM\Column(name="race", type="string", length=45, nullable=false)
     */
    private $race;
     ...
     * @var string
     *
     * @ORM\Column(name="sexe", type="string", length=45, nullable=false)
     */
    private $sexe;
     ...
     * @var \Helmet
     *
     * @ORM\ManyToOne(targetEntity="Helmet")
     * @ORM\JoinColumns({
     ...
     * @var \Leg
     *
     * @ORM\ManyToOne(targetEntity="Leg")
     * @ORM\JoinColumns({
